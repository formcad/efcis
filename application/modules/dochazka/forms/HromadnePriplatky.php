...
/**
 * Formulář pro přidání hromadných příplatků v docházce
 */
class Dochazka_Form_HromadnePriplatky extends ZendX_JQuery_Form
{
    /**
     * Typy příplatků
     * @var array
    ...
    public function init()
    {
        ...
        $this->setName("hromadnePriplatkyForm");
        $this->setAttrib("id", "form-dochazka-addHromadnePriplatky");
        $this->setMethod('post');     
        ...
        $preruseni->setLabel('Typ příplatku')
                ->setRequired(true)
                ->addValidator(new Zend_Validate_NotEmpty);
        ...
        $delkaPreruseni = new Zend_Form_Element_Text('delkaPriplatku');
        ...
        $submit = new Zend_Form_Element_Submit('hromadnePriplatkySubmit');
